This is a comprehensive README.md file designed for a GitHub repository acting as a central hub for your research papers and their associated code implementations.
It is structured to present your work as a cohesive research program (The Phenomenal Manifold Framework), categorizing the papers by their specific contributions (Theoretical, Architectural, Experimental) and clearly stating the status of the code for each.
...
Subtitle: A Geometric Framework Induced by Informational Dynamics 📅 Date: November 2025 (Revised)
 * Abstract: Proposes that conscious experience is a low-dimensional Riemannian manifold (\Psi) projected from high-dimensional neural parameter space. Defines the "Hybrid Metric" combining information geometry with three neural invariants: Integration (\mathcal{I}), Coherence (\Gamma), and Differentiation (\Delta).
 * Key Contributions: * Formal definition of the projection \pi: \mathcal{P}(M_4) \rightarrow \Psi.
...
Subtitle: A Gromov-Wasserstein Framework for Neural-Phenomenal Alignment 📅 Date: January 2026
 ...
 * Key Experiment: Color Ring Toy Model — Recovering circular topology (\beta_1 = 1) from noisy neural spike trains.
...
Subtitle: A Geometric-Dynamical Framework for Hierarchical Representation Learning 📅 Date: January 2026
 ...
 * Key Contributions:
   * Manifold Capacity bounds proving exponential advantage (\Omega(e^r)).
   * Geometric Frustration (\mathcal{F}) as a misalignment metric.
   * Phase-transition failure modes in structural coherence.
 * 💻 Code Status: In Progress (Synthetic validations & H-AKOrN dynamics).
   * Path: /src/lmt_model
4. The \Psi-Former
Subtitle: Topological Downward Causation via Riemannian Optimization 📅 Date: January 2026
...
Subtitle: A Geometric Framework for Emergent Complexity 📅 Date: January 7, 2026
...
Implementation of the hyperboloid model \mathbb{L}^n for numerical stability:
...
Used for enforcing Global Coherence (\Gamma).
🧬 Topological Data Analysis (TDA)
Tools for computing Persistent Homology (Betti numbers \beta_k) and Gromov-Wasserstein distances to validate structural isomorphism between neural and phenomenal spaces.
...
⚠️ Disclaimer
This is a research repository. The \Psi-Former and H-NCA are theoretical architectures designed to investigate the structural correlates of consciousness. The Phenomenal Risk Score (PRS) is a proposed ethical heuristic, not a definitive test for sentience.
