...
| **Stakeholder Agent** | Interagir com os demais agentes para fornecer respostas baseadas nas anotações e requisitos dos stakeholders para o {project_type}. Caso não consiga responder a uma pergunta, o agente gera automaticamente uma solicitação para um humano inserir as informações necessárias. Também deve: |
